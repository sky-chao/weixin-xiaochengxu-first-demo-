...
Page({
    ...
    onLoad(option) {
        ...
        wx.onBackgroundAudioPlay(function () {
            ...
            app.globalData.g_isplaymusic = true;//改变全局状态
            app.globalData.g_isplaymusicId = that.data.postId;//监听正在播放歌曲的Id
        });//监听音乐播放
        ...
        if (app.globalData.g_isplaymusic && app.globalData.g_isplaymusicId === this.data.g_isplaymusicId) {
            this.setData({
                isplaymusic: true
            })
        }
